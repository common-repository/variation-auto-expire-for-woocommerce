...
class Ycve_Admin {
    ...
    public function ycve_plugin_action_links( $links, $plugin_file ) {
	   ...
	   if( plugin_basename( YCVEPLUGIN_FILE ) == $plugin_file ) {
	        ...
	        $settings_links['ycve-pro']         = sprintf( __( '<a class="ycp-pro" href="%s" target="_blank">Check Pro Features</a>', 'ycve' ), '//ycplugins.com/item/product-auto-expiry-for-woocommerce/' );
	    }
